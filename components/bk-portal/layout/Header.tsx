...
// right area shows the user avatar / info. Uses responsive left offset (md:left-64).
// Accepts optional onToggleSidebar prop; if not present, dispatches a global event and toggles a `sidebar-open` class.
