...
const CategoryCard: React.FC<CategoryCardProps & { gradient?: string }> = ({ icon: Icon, title, description, articles, gradient }) => (
  <button className="bg-white border border-gray-200 rounded-xl p-6 text-left hover:shadow-lg transition-shadow flex items-start gap-4">
        ...
        <div className="rounded-xl overflow-hidden relative">
          <div className="bg-gradient-to-r from-indigo-500 via-blue-500 to-purple-600 text-white p-8 rounded-xl flex items-center justify-between">
            <div>
              ...
              <button className="bg-white text-indigo-600 px-4 py-2 rounded-md font-medium shadow">Ajukan Pertanyaan</button>
            </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="mt-4 flex gap-3">
                <button className="px-3 py-2 rounded-md border border-green-200 text-green-700 bg-white">Chat dengan BK</button>
                <button className="px-3 py-2 rounded-md border border-green-300 text-green-700 bg-green-50">Buat Reservasi</button>
              </div>
            </div>
          </div>
        </div>
