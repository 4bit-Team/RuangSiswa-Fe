...
const AppointmentScheduleModal: React.FC<AppointmentScheduleModalProps> = ({
  ...
  const fetchAvailableCounselors = async (
    ...
    try {
      ...
      console.log(
        `📞 Fetching available counselors for ${formattedDate} at ${time}`,
      );
      const response = await apiRequest(
        ...
        <div className="p-6">
          <div className="space-y-6">
            ...
            <div className="min-h-64">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-600">
                        Konsultasi langsung dengan konselor
                      </p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-600">
                        Konsultasi melalui chat dengan konselor
                      </p>
                    </button>
                  </div>
                </div>
                  ...
                  {loadingCategories ? (
                    <div className="flex items-center justify-center py-8">
                      ...
                      <span className="text-gray-600">
                        Memuat topik konseling...
                      </span>
                    </div>
                  ) : counselingCategories.length === 0 ? (
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                      <p className="text-yellow-800">
                        Tidak ada topik konseling tersedia
                      </p>
                    </div>
                  ) : (
                    <div className="space-y-3">
              ...
              {step === 2 && counselingType !== "Konseling Lainnya" && (
                <div className="space-y-6">
                  {/** Optional topic selector for other counseling types **/}
                  {loadingCategories ? (
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          const cat = counselingCategories.find(
                            (c: any) => c.id === id,
                          );
                          if (cat) {
                            setSelectedTopic({ id: cat.id, name: cat.name });
                            setFormData({ ...formData, topicId: cat.id });
                          } else {
                            setSelectedTopic(null);
                            setFormData({ ...formData, topicId: null });
                          }
                        }}
                        className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500"
                      >
                        <option value="">Pilih topik (opsional)</option>
                        {counselingCategories.map((c: any) => (
                        ...
                        <div>
                          ...
                          {loadingCounselors ? (
                            <div className="flex items-center justify-center py-8">
                              <Loader className="w-5 h-5 animate-spin text-indigo-500 mr-2" />
                              <span className="text-gray-600">
                                Memuat konselor tersedia...
                              </span>
                            </div>
                          ) : availableCounselors.length === 0 ? (
                            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                              <p className="text-yellow-800">
                                Tidak ada konselor tersedia untuk waktu ini
                              </p>
                            </div>
                          ) : (
                            <div className="grid grid-cols-3 gap-3">
                              {availableCounselors.map((counselor: any) => (
                                <button
                                  ...
                                  onClick={() =>
                                    !counselor.booked &&
                                    handleCounselorSelect(counselor.id)
                                  }
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl p-6 border border-indigo-200 space-y-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start gap-3">
                        <div className="w-5 h-5 text-indigo-500 flex-shrink-0 mt-0.5 font-semibold">
                          📋
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-gray-900">
                            {availableCounselors.find(
                              (c: any) => c.id === formData.counselorId,
                            )?.fullName || "Belum dipilih"}
                          </p>
        ...
        <div className="border-t border-gray-200 px-6 py-4 bg-gray-50 flex gap-3 sticky bottom-0">
          ...
          <button
            ...
            disabled={
              ...
              (step === 2 &&
                counselingType !== "Konseling Lainnya" &&
                (!formData.date || !formData.time || !formData.counselorId)) ||
              (step === 3 &&
                counselingType === "Konseling Lainnya" &&
                (!formData.date || !formData.time || !formData.counselorId)) ||
              (step === 3 &&
          ...
          >
            {(counselingType === "Konseling Lainnya" && step === 4) ||
            (counselingType !== "Konseling Lainnya" && step === 3)
              ? "Konfirmasi Reservasi"
              : "Lanjut"}
          </button>
        </div>
